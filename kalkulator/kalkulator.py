...
Original file is located at
    https://colab.research.google.com/drive/12TEEzhCYVq4EjK9LZqtsOCcmcVtc-Yi5
"""
...
def main():
    ...
    st.image("animasi_awal.gif", use_column_width=True, caption="Selamat Datang!")
    ...
    st.image("animasi_akhir.gif", use_column_width=True, caption="Terima Kasih!")
